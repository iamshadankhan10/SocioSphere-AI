...
// - Link to signup page
//
// This is a client component because it has form interactions.
// =============================================================
...
export default function LoginPage() {
  ...
  // Handle form submission (dummy — no real auth yet)
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Connect to real authentication backend
    alert("Login functionality will be connected in a future step!");
  };
